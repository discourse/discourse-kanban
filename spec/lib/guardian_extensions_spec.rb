...
RSpec.describe DiscourseKanban::GuardianExtensions do
  ...
  describe "#can_read_board?" do
    ...
    it "returns true when the user can write" do
      board = DiscourseKanban::Board.create!(name: "Operations", slug: "operations")
      Fabricate(
        :access_control_list_with_groups,
        target: board,
        permission: "edit",
    ...
    it "grants public read to anonymous and logged in users via the anonymous and trust level 0 groups" do
      board = DiscourseKanban::Board.create!(name: "Public", slug: "public")
      Fabricate(
        :access_control_list,
        target: board,
        permission: "view",
  ...
  describe "#can_write_board?" do
    ...
    it "does not grant write to admins without an edit or manage ACL" do
      board = DiscourseKanban::Board.create!(name: "Engineering", slug: "engineering")
