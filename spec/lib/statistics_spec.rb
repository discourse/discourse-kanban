...
RSpec.describe DiscourseKanban::Statistics do
  fab!(:admin)
  fab!(:user_one, :user)
  fab!(:user_two, :user)
  fab!(:user_three, :user)
  ...
  describe ".viewed_boards" do
    ...
    fab!(:recent_board) { Fabricate(:kanban_board, name: "Viewed Recent", created_by: admin) }
    fab!(:week_board) { Fabricate(:kanban_board, name: "Viewed Week", created_by: admin) }
    fab!(:previous_month_board) do
      Fabricate(:kanban_board, name: "Viewed Previous Month", created_by: admin)
    end
  ...
  describe ".active_boards" do
    ...
    fab!(:recent_board) { Fabricate(:kanban_board, name: "Active Recent", created_by: admin) }
    fab!(:month_board) { Fabricate(:kanban_board, name: "Active Month", created_by: admin) }
    fab!(:previous_month_board) do
      Fabricate(:kanban_board, name: "Active Previous Month", created_by: admin)
    end
    fab!(:column) { Fabricate(:kanban_column, board: recent_board) }
    fab!(:recent_card) { Fabricate(:kanban_card, board: recent_board, column:) }
    fab!(:month_card) do
      Fabricate(
        :kanban_card,
        board: month_board,
        column: Fabricate(:kanban_column, board: month_board),
      )
    end
    fab!(:previous_month_card) do
      Fabricate(
        :kanban_card,
        board: previous_month_board,
        column: Fabricate(:kanban_column, board: previous_month_board),
      )
    end
  ...
  describe ".active_users" do
    ...
    fab!(:board) { Fabricate(:kanban_board, name: "Active Users Board", created_by: admin) }
    fab!(:column) { Fabricate(:kanban_column, board:) }
    fab!(:card) { Fabricate(:kanban_card, board:, column:) }
  ...
  describe ".participating_users" do
    ...
    fab!(:board) { Fabricate(:kanban_board, name: "Participating Users Board", created_by: admin) }
    fab!(:column) { Fabricate(:kanban_column, board:) }
    fab!(:card) { Fabricate(:kanban_card, board:, column:) }
