...
module DiscourseKanban
  class ColumnMutator
    def self.apply!(column:, attributes:, guardian:, position: column.position)
    ...
    def self.resolve_tag_id(payload, guardian)
    ...
    def self.ensure_tag_is_unique!(column:, tag_id:, tag_name:)
    ...
    private_class_method :ensure_tag_is_unique!

    def self.compact_positions!(board)
      board
        .columns
        .order(:position, :id)
    ...
    private_class_method :compact_positions!
  end
end
