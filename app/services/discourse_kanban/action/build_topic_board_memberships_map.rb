  ...
  module Action
    class BuildTopicBoardMembershipsMap < Service::ActionBase
      ...
      def readable_board_ids
        member_boards =
          DiscourseKanban::Board.with_any_acl_permissions(guardian, %w[view edit manage])
        anonymous_boards = DiscourseKanban::Board.with_any_acl_permissions(Guardian.new, %w[view])
