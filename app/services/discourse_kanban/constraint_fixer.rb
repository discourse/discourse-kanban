...
module DiscourseKanban
  module ConstraintFixer
    ...
    #
    def self.apply!(fix:, board:, topic:, guardian:)
    ...
    def self.apply_category_fix!(fix, board, topic, guardian)
      ...
      first_post.revise(
        ...
        { bypass_bump: true, validate_post: false, bypass_rate_limiter: true, skip_revision: true },
      )
      topic.reload
    end
    ...
    private_class_method :apply_category_fix!, :apply_tag_fix!
  end
end
