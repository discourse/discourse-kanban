const REORDER_ANIMATION = Symbol("kanban-reorder-animation");

// Keep in sync with the matching CSS vars in kanban-board.scss.
export const KANBAN_REORDER_DURATION = 180;
export const KANBAN_MOTION_EASING = "cubic-bezier(0.4, 0, 0.2, 1)";

export function kanbanMotionEnabled() {
...
export function animateCardReorder(
  ...
  if (!kanbanMotionEnabled() || !container || !previousRects?.size) {
    return;
  }
