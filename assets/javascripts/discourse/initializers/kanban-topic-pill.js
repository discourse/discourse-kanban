...
import KanbanBoardsMenu from "../components/kanban-boards-menu";
import {
  kanbanTagsHtml,
  membershipsFor,
  MULTI_BOARD_TRIGGER_SELECTOR,
} from "../lib/kanban-topic-pill";
...
class KanbanTopicPills {
  ...
  constructor(owner) {
    ...
    withPluginApi((api) => api.addTagsHtmlCallback(kanbanTagsHtml));
...
export default {
  ...
  initialize(_container, owner) {
    this.instance = new KanbanTopicPills(owner);
  },
